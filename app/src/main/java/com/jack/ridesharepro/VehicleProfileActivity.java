    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                Intent i = new Intent(VehicleProfileActivity.this, MenuActivity.class);
                startActivity(i);
            }
        });
...
//                    Toast.makeText(VehicleProfileActivity.this, "Please fill in required parameters", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
